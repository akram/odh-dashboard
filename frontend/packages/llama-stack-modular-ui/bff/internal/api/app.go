...
func (app *App) Routes() http.Handler {
	...
	// OpenAPI routes (unprotected) - handle these before the catch-all handler
	appMux.HandleFunc(OpenAPIPath, app.openAPI.HandleOpenAPIRedirectWrapper)
	appMux.HandleFunc(OpenAPIJSONPath, app.openAPI.HandleOpenAPIJSONWrapper)
	appMux.HandleFunc(OpenAPIYAMLPath, app.openAPI.HandleOpenAPIYAMLWrapper)
	appMux.HandleFunc(SwaggerUIPath, app.openAPI.HandleSwaggerUIWrapper)
